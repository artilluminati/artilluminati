...
export default function LogoAnimated() {
    useEffect(() => {
        !(function (t, n) {
            ...
            d(Math.pow(10, -2)), d(Math.pow(10, -4));
            var b = Math.PI / 180;
            function w(t) {
                return t * b;
            }
            ...
            function nt(t, n, r, i, u) {
                ...
                switch (
                    ...
                    case "function":
                        if (((f = s(i, u, W, K, r, a, n, t)), l)) return f;
                        break;
                    case "string":
                        f = X(i, Z(s));
                        break;
                    case "object":
                        if ((f = X(i, Z(s.i), s.f)) && "function" == typeof s.u)
            ...
            function ut(t, n) {
                for (
                    var e = n.querySelectorAll("svg"), r = 0;
                    r < e.length;
                    r++
                )
            ...
            function at(t) {
                ...
                if (r) return r;
                if (e >= 20) return null;
                for (var i = ot(n), u = 0; u < i.length; u++) {
                    var o = at(t, i[u], e + 1);
                    if (o) return o;
                }
                return null;
            ...
            function ft(t, n, e) {
                return !t || !e || n > t.length
                    ? t
                    : t.substring(0, n) + ft(t.substring(n + 1), e, e);
            }
            function ct(t) {
                var n =
                    arguments.length > 1 && void 0 !== arguments[1]
            ...
            function pt(t) {
                var n =
                    arguments.length > 1 && void 0 !== arguments[1]
                        ? arguments[1]
                        : " ";
                return t && t.length ? t.map(gt).join(n) : "";
            }
            function dt(t) {
                return t
                    ? null == t.a || t.a >= 1
            ...
            var bt = {
                    ...
                    u: function (t, n) {
                        return function (e) {
                            var r = n(e);
                            t.setAttribute("rx", gt(r.x)),
                                t.setAttribute("ry", gt(r.y));
                        };
                    },
                },
                wt = {
                    ...
                    u: function (t, n) {
                        return function (e) {
                            var r = n(e);
                            t.setAttribute("width", gt(r.width)),
                                t.setAttribute("height", gt(r.height));
                        };
                    },
                };
            Object.freeze({
            ...
            function Mt(t, n, e) {
                var r =
                        ...
                        void 0 !== arguments[3] &&
                        arguments[3],
                    i = { x: jt(t.x, n.x, e), y: jt(t.y, n.y, e) };
                return r && (i.a = Et(t, n)), i;
            }
            function Et(t, n) {
            ...
            function Ft(t, n, e, r) {
                return Math.atan2(It(t.y, n.y, e.y, r), It(t.x, n.x, e.x, r));
            }
            ...
            function qt(t, n, e, r, i) {
                ...
                return (
                    o ||
                        (o = {
                            x: Nt(t.x, n.x, e.x, r.x, i),
                            y: Nt(t.y, n.y, e.y, r.y, i),
                        }),
                    u && (o.a = Bt(t, n, e, r, i)),
                    o
                );
            ...
            function Bt(t, n, e, r, i) {
                return Math.atan2(
                    Tt(t.y, n.y, e.y, r.y, i),
                    Tt(t.x, n.x, e.x, r.x, i)
                );
            }
            function Dt(t, n, e) {
                var r =
                    ...
                    arguments[3];
                if (Ct(n)) {
                    if (Vt(e)) return Rt(n, e.start, e, t, r);
                } else if (Ct(e)) {
                    if (Gt(n)) return Rt(n, n.end, e, t, r);
                } else {
                    if (Gt(n))
                        return Vt(e)
                            ? qt(n, n.end, e.start, e, t, r)
                            : Rt(n, n.end, e, t, r);
                    if (Vt(e)) return Rt(n, e.start, e, t, r);
                }
                return Mt(n, e, t, r);
            ...
            function Vt(t) {
                return null != t.start && !Ct(t);
            }
            function Gt(t) {
                return null != t.end && !Ct(t);
            }
            var zt = new T();
            var Yt = { f: gt, i: D },
                $t = { f: gt, i: C };
            ...
            function Ht(t, n, r, i, u, o, a, l) {
                return (
                    ...
                    function (i) {
                        var u = r(i, t, Jt);
                        if (!u) return "none";
                        if ("c" === u.t) return dt(u.v);
                        if ("g" === u.t) {
                            if (!n[u.r]) return mt(u.r);
                            var o = n[u.r];
                            return (
                                (function (t, n) {
                                    for (
            ...
            function Jt(t, e, r) {
                ...
                if (e && r) {
                    ...
                    if (
                        ...
                        return (
                            (a.s = "c" === e.t ? Zt(t, l, a.s) : Zt(t, a.s, l)),
                            a
                        );
                    }
                }
            ...
            function Kt(t, n, e) {
                return { o: C(t, n.o, e.o || 0), c: z(t, n.c, e.c || {}) };
            }
            function Wt(t) {
                ...
                animations: [
                    {
                        elements: {
                            eKxNG7mtEfo5: {
                                "#size": [
                                    { t: 0, v: { width: 80, height: 69 } },
                                    { t: 500, v: { width: 80, height: 69 } },
                                ],
                                transform: {
                                    data: {
                                        o: {
                        ...
                        s: "",
                    },
                ],
                options:
                    "MUDAxMDg4MmZEODA4MTCZlN2Y4MTJmNDcyZlAF3OTdjNmU3MTJmTjhhR",
            },
            "__SVGATOR_PLAYER__",
            window,
            document
